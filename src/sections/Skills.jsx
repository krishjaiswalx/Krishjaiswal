...
export default function Skills() {
  ...
  // Scroll + touch direction detection
  useEffect(() => {
    if (!active) return;
  ...
  return (
    <section
      id="skills"
      ref={sectionRef}
      className="min-h-[60vh] w-full pb-12 flex flex-col items-center justify-center relative bg-black text-white overflow-hidden"
    >
      {/* Background Blur */}
      ...
      {/* Heading */}
      <motion.h2
        className="text-4xl mt-5 sm:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#1cd8d2] via-[#00b8f8] to-[#302b63] z-10"
      ...
      <motion.p
        ...
        transition={{ duration: 0.5 }}
      >
        Full Stack Development | Tools | Deployment
      </motion.p>
